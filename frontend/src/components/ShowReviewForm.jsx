...
function ShowReviewForm({ rating, body, handleChange, handleReviewSubmit }) {
  ...
  return (
    <>
      <form onSubmit={handleReviewSubmit} className="my-5 md:mt-10">
        ...
        <button className={`btn btn-sm bg-green-700 hover:bg-green-800 w-full ${user ? "" : "btn-disabled"}`}>Submit Review</button>
      </form>
    </>
  )
}
